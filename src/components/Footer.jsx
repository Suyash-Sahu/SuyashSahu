...
const socialLinks = [
  {
    name: 'GitHub',
    url: 'https://github.com/Suyash-Sahu',
    icon: (
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/suyash-sahu-839195292/',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Email',
    url: 'mailto:suyash1811980@gmail.com',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className={`${styles.paddingX} mx-auto px-4`}>
        <div className="flex flex-wrap text-center lg:text-left">
          ...
          >
            ...
            >
              Full Stack Developer | Building digital experiences with passion and precision.
            </motion.p>
          </motion.div>
